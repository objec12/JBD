...
import com.objectia.JBD_HandsOnLearning.dtos.AccountRequestDTO;
import com.objectia.JBD_HandsOnLearning.dtos.AccountResponseDTO;
...
public class AccountController {
    ...
    public ResponseEntity<AccountResponseDTO> createAccount(@RequestBody @Valid AccountRequestDTO accountRequestDTO) throws Exception {
            ...
            Account createdAccount = accountService.createAccount(account,accountRequestDTO.getAccountHolderId());
